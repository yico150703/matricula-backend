"""Script maestro de migración y seed completo con la nueva estructura rigurosa de la base de datos.
Incluye Facultad, Escuela, PlanEstudio, Curso, MezclaCurso, PeriodoAcademico, Horarios y Alumno.
"""
...
def main():
    ...
    with app.app_context():
        ...
        # -----------------------------------------------------------------
        print("8. Creando alumno de prueba oficial en FIIS...")
        alumno = Alumno(
            cod_alumno="20260001",
            nombres="Ana",
            apellidos="Pérez",
            email="alumno@unfv.edu.pe",
        ...
        db.session.commit()
        print("✓ Alumno 20260001 (Ana Pérez) creado exitosamente.")

        print("==========================================================")
        print("¡BASE DE DATOS REESTRUCTURADA Y POBLADA CON ÉXITO TOTAL!")
        print("==========================================================")
